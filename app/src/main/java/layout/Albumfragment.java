...
public class Albumfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      /*  Button b; b=(Button) rootView.findViewById(R.id.onnosomoysongbutton);
        Button b2; b2=(Button) rootView.findViewById(R.id.oniketprantorsongbutton);
      ...
      //  return inflater.inflate(R.layout.fragment_albumfragment, container, false);
        return  rootView;
    }
