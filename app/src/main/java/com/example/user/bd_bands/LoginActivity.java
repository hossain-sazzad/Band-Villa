            ...
            public void onClick(View view) {
                ...
                StringRequest sq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        {
                            Toast.makeText(getApplicationContext(), " invalid user! registration succeded", Toast.LENGTH_LONG).show();
                    ...
                    protected Map<String, String > getParams(){
                        ...
                        parr.put("email",email);
                        parr.put("password", password);
          ...
          //  mAuthTask = new UserLoginTask(email, password);
            ...
            StringRequest sq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                      ...
                      String a="\"successful\"";
                    String b="\"invalid password\"";
                    String c="\"user does mot exists!!!\"";
                    Log.d("msg",response);
                   ...
                   if(response.equals(b)){
                        Toast.makeText(getApplicationContext(),"login "+response, Toast.LENGTH_LONG).show();
                       ...
                       Log.d("msg",response+" hoise");

                       Toast.makeText(getApplicationContext(),"login successful"+response, Toast.LENGTH_LONG).show();
                       SingletonClass.loginstate=1;
                       SingletonClass.userid=Integer.parseInt(response);
                       Log.d("neww",response);
